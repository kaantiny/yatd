...
- **Workflow skills embedded in the binary** (`td-plan`, `td-decompose`, `td-review`, `td-spec`, `td-execute`) — no separate download needed
...
# Install ALL skills (default - base + 5 workflow skills)
td skill
...
# Install to custom directory (default: ~/.config/agents/skills)
td skill --dir ./my-custom-skills

# Install from local directory (for custom skills)
td skill --from-dir ./local-skills --dir ./installed-skills
```
